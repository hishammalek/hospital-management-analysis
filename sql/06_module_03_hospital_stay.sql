...
SELECT
    ROUND(
        AVG(discharge_date - admission_date), 2
...
JOIN calendar c
    ON pe.event_date = c.calendar_date
GROUP BY
    c.year,
    c.month,
    c.month_no,
...
-- =====================================================
 ...
 -- months requriring addiotional operational planning.
-- =====================================================
...
JOIN admissions a
    ON a.admission_date <= mc.month_end
...
SELECT
    ...
    a.patient_id,
      ...
      CASE
        WHEN EXTRACT(YEAR FROM AGE(a.admission_date, p.date_of_birth)) BETWEEN 0 AND 17
            THEN '0-17 years'
        
        WHEN EXTRACT(YEAR FROM AGE(a.admission_date, p.date_of_birth)) BETWEEN 18 AND 35
            THEN '18-35 years'
        
        WHEN EXTRACT(YEAR FROM AGE(a.admission_date, p.date_of_birth)) BETWEEN 36 AND 50
            THEN '36-50 years'
        
        WHEN EXTRACT(YEAR FROM AGE(a.admission_date, p.date_of_birth)) BETWEEN 51 AND 65
            THEN '51-65 years'
...
SELECT
    ...
    COUNT(a.admission_id) AS total_admissions,
    ROUND(
        (COUNT(a.admission_id) * 100.0 / SUM(COUNT(a.admission_id)) OVER () ), 2
...
-- =====================================================
 ...
 -- patient demographic, patterns and support healtcare resource planning.
-- =====================================================
